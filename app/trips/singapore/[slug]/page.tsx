                  ...
                  {Array.isArray(trip.itinerary) && trip.itinerary.length > 0 ? trip.itinerary.map(day => (
                    ...
                    >
                      <button
                        ...
                        className="w-full flex items-start justify-between p-[3vw] sm:p-5 bg-white hover:bg-slate-50 transition-colors"
                      >
              ...
              <section id="batches">
                ...
                <Card className="p-6 space-y-4">
                  ...
                  {(!trip.batchDates || trip.batchDates.length === 0) && (
                    <p className="text-slate-600">No batch dates currently scheduled. Please enquire for custom dates.</p>
                  )}
                </Card>
              </section>
                  ...
                  <div className="overflow-x-auto">
                    <table className="min-w-full text-left divide-y divide-slate-200">
                      ...
                      <tbody className="divide-y divide-slate-200">
                        ...
                        {(!trip.costingDetails || trip.costingDetails.length === 0) && (
                          <tr>
                            <td className="px-4 py-4 text-slate-700 font-medium">Standard Package</td>
                            <td className="px-4 py-4 text-slate-700">₹{trip.price.toLocaleString('en-IN')}</td>
                          </tr>
                        )}
                      </tbody>
                    </table>
              ...
              <section id="note">
                ...
                <Card className="p-6">
                  {Array.isArray(trip.note) ? (
                    ...
                    <p className="text-slate-600">No additional notes for this trip.</p>
                  )}
                </Card>
              </section>
                ...
                <Card className="p-6">
                  <div className="space-y-3">
                    ...
                    {(!trip.stays || trip.stays.length === 0) && (
                      <p className="text-slate-600">Stay details will be provided upon booking.</p>
                    )}
                  </div>
                </Card>
              </section>
                    ...
                    <AccordionContent>
                      <div className="space-y-3">
                        ...
                        {(!trip.paymentPolicy || trip.paymentPolicy.length === 0) && (
                          <p className="text-slate-600">Standard payment terms apply. Please contact us for details.</p>
                        )}
                      </div>
                    </AccordionContent>
                  </AccordionItem>
                    ...
                    <AccordionContent>
                      <div className="space-y-3">
                        ...
                        {(!trip.cancellationPolicy || trip.cancellationPolicy.length === 0) && (
                          <p className="text-slate-600">Standard cancellation policy applies. Refer to terms and conditions.</p>
                        )}
                      </div>
                    </AccordionContent>
                  </AccordionItem>
                    ...
                    <AccordionContent>
                      <div className="space-y-3">
                        ...
                        {(!trip.thingsToCarry || trip.thingsToCarry.length === 0) && (
                          <p className="text-slate-600">A detailed list of essentials will be shared before the trip.</p>
                        )}
                      </div>
                    </AccordionContent>
                  </AccordionItem>
                    ...
                    <AccordionContent>
                      <div className="space-y-6">
                        ...
                        {(!trip.travelEssentials || trip.travelEssentials.length === 0) && (
                          <p className="text-slate-600">General travel guidelines apply for this destination.</p>
                        )}
                      </div>
                    </AccordionContent>
                  </AccordionItem>
