...
export default function BaliPage() {
  const categoryId = 'bali'
  const categoryName = 'Bali'
              ...
              <div className="  text-white ">
                <div className="max-w-2xl">
                  ...
                  <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold tracking-tight leading-tight">
                    20+ Bali Tour Packages 2026
                  </h1>

                  <p className={`mt-3 md:mt-0 text-sm sm:text-base md:text-lg max-w-2xl text-white leading-normal ${!isDescExpanded ? 'line-clamp-3 md:line-clamp-none' : ''}`}>
                    All inclusive curated Best Bali Group & Customised Tour Packages 2026 For Friends Family Kids & Couples covering all the major places Ubud , Nusa Dua , Seminyak , Kuta , Gili Island , Nusa Penida.
                  </p>
                  <button
                  ...
                  <div className="mt-5 md:mt-5 flex flex-row gap-2 sm:flex-row sm:items-center">
                    ...
                    <Button
                      ...
                      onClick={() => {
                        const message = `Hi Wanderphilia, I want to inquire about Bali from Website`
...
<div className="hidden md:block relative">{/* DESKTOP CAROUSEL */}
        ...
        <section className="py-16 px-4 md:px-8 lg:px-16 max-w-7xl mx-auto">
          <div className="mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
              Bali Group Tours 2026 - Wanderphilia Exclusive
            </h2>
            <div className="w-20 h-1 bg-primary rounded-full" />
          </div>
...
<div className="hidden md:block relative">{/* DESKTOP CAROUSEL */}
        ...
        <section className="py-16 px-4 md:px-8 lg:px-16 max-w-7xl mx-auto">
          <div className="mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
              Honeymoon Bali Getaway - Wanderphilia Exclusive
            </h2>
            <div className="w-20 h-1 bg-primary rounded-full" />
          </div>
