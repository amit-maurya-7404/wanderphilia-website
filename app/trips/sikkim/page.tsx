...
export default function SikkimPage() {
  const categoryId = 'sikkim'
  const categoryName = 'Sikkim'
    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-grow">
        ...
        <div className="relative h-[50vh] sm:h-[50vh] md:h-[70vh] min-h-75 pt-20">
          <TripHeroCarousel media={firstTrip?.heroMedia || [{ type: 'image' as const, src: firstTrip?.image || '/images/sikkim.png', alt: categoryName }]} />
              ...
              <div className="  text-white ">
                <div className="max-w-4xl">
                  ...
                  <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold tracking-tight leading-tight">
                    10+ Sikkim Darjeeling Tour Packages 2026
                  </h1>

                  <p className="mt-3 md:mt-0 text-sm sm:text-base md:text-lg max-w-2xl text-white leading-relaxed">
                    All inclusive curated Best Sikkim Darjeeling customised Tour Packages 2026 covering Gangtok , Pelling , Lachung , Lachen , Darjeeling , Mirik , Kallimpong.
                  </p>
                  ...
                  <div className="mt-5 md:mt-5 flex flex-row gap-2 sm:flex-row sm:items-center">
                    ...
                    <Button
                      ...
                      onClick={() => {
                        const message = `Hi Wanderphilia, I want to inquire about Sikkim from Website`
