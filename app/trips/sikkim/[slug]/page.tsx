              ...
              <section id="batches">
                ...
                <Card className="p-6 space-y-4">
                  {trip.batchDates && trip.batchDates.length > 0 ? (
                    ...
                    <p className="text-slate-500 text-sm">No fixed batches scheduled. Contact us for custom travel dates.</p>
                  )}
                </Card>
              </section>
                    ...
                    <AccordionContent>
                      <div className="space-y-3">
                        {trip.paymentPolicy && trip.paymentPolicy.length > 0 ? (
                          ...
                          <p className="text-slate-500 text-sm">Please contact us directly for booking terms and payment schedule.</p>
                        )}
                      </div>
                    </AccordionContent>
                  </AccordionItem>
                    ...
                    <AccordionContent>
                      <div className="space-y-3">
                        {trip.cancellationPolicy && trip.cancellationPolicy.length > 0 ? (
                          ...
                          <p className="text-slate-500 text-sm">Cancellation policy details will be shared at the time of inquiry.</p>
                        )}
                      </div>
                    </AccordionContent>
                  </AccordionItem>
                    ...
                    <AccordionContent>
                      <div className="space-y-6">
                        {trip.travelEssentials && trip.travelEssentials.length > 0 ? (
                          ...
                          <p className="text-slate-500 text-sm">No specific travel essentials listed. Please prepare for general mountain weather.</p>
                        )}
                      </div>
                    </AccordionContent>
                  </AccordionItem>
