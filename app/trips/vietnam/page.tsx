...
export default function VietnamPage() {
  const categoryId = 'vietnam'
  const categoryName = 'Vietnam'
    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-grow">
        ...
        <div className="relative h-[50vh] sm:h-[45vh] md:h-[70vh] overflow-hidden pt-20">
          <TripHeroCarousel media={firstTrip?.heroMedia || [{ type: 'image' as const, src: firstTrip?.image || '/images/vietnam.png', alt: categoryName }]} />
              ...
              <div className="text-white">
                <div className="max-w-4xl">
                  ...
                  <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold tracking-tight leading-tight">
                    10+ Vietnam Tour Packages 2026
                  </h1>

                  <p className="mt-4 text-sm sm:text-base md:text-lg max-w-2xl text-slate-100 leading-normal">
                    All inclusive curated Best Vietnam Group & Customised Tour Packages 2026 For Friends Family Kids & Couples covering all the major places Hanoi, Danang, Sapa , PhuQuoc , Saigon ,  Ha long Bay , Hoi An , Ho Chi Minh.
                  </p>
                  ...
                  <div className="mt-5 flex flex-row gap-2 sm:flex-row sm:items-center">
                    ...
                    <Button
                      ...
                      onClick={() => {
                        const message = `Hi Wanderphilia, I want to inquire about Vietnam from Website`
        ...
        <section className="py-16 px-4 md:px-8 lg:px-16 max-w-7xl mx-auto">
          <div className="mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
              Vietnam Upcoming Trips 2026 - Wanderphilia Exclusives
            </h2>
        ...
        {groupPackages.length > 0 && (
          <section className="py-16 px-4 md:px-8 lg:px-16 max-w-7xl mx-auto">
            <div className="mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
                Vietnam Upcoming Group Trips 2026 - Wanderphilia Exclusive
              </h2>
              <div className="w-20 h-1 bg-primary rounded-full" />
            </div>
        ...
        <section className="py-16 px-4 md:px-8 lg:px-16 max-w-7xl mx-auto">
          <div className="mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
              Family Special Vietnam Vacation - Wanderphilia Exclusive
            </h2>
            <div className="w-20 h-1 bg-primary rounded-full" />
          </div>
        ...
        <section className="py-16 px-4 md:px-8 lg:px-16 max-w-7xl mx-auto">
          <div className="mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
              Honeymoon Vietnam Getaway - Wanderphilia Exclusive
            </h2>
            <div className="w-20 h-1 bg-primary rounded-full" />
          </div>
